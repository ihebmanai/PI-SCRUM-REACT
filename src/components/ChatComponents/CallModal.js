...
class CallModal extends Component {
    ...
    render() {
      /** CONFIG **/
      let SIGNALING_SERVER = "http://localhost:3000";
      let USE_AUDIO = true;
      let USE_VIDEO = true;
      ...
      function init() {
          ...
          signaling_socket.on('addPeer', function (config) {
              ...
              peer_connection.onaddstream = function (event) {
                  ...
                  let remote_media = USE_VIDEO ? document.createElement('video') : document.createElement('audio');

                  remote_media.style.width = '200px';
                  remote_media.style.width = '150px';
                  remote_media.style.border = '0px';
                  remote_media.style.top = '-117px';
                  remote_media.style.left = '80%';

                  remote_media.setAttribute('id', 'videoRemote');
                  ...
                  document.getElementById('body').appendChild(remote_media);
      ...
      function setup_local_media(callback, errorback) {
          ...
          navigator.getUserMedia({"audio": USE_AUDIO, "video": USE_VIDEO},
              function (stream) { /* user accepted access to a/v */
                  ...
                  let local_media = USE_VIDEO ? document.createElement('video') : document.createElement('audio');
                  ...
                  document.getElementById('body').appendChild(local_media);
        ...
        return (
            ...
            <div className="app-body">
              ...
              <Container fluid  onLoad={init()}>
                  <Suspense fallback={this.loading()}>
                 
    
                  <Link to="/createmeeting" className="navbar-brand">MERN-Stack Todo App</Link>
                  <Button icon="phone-slash"
                                     className="fa-3x circle-icon"
                                     style={{color: 'white'}}
                                     onClick={() => {
